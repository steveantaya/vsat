    ...
    var obj = \{\
        ...
        controller: ['$scope', function($scope) \{\
            ...
            AddressList.shipping(function(list) \{\
                ...
                \}\
                /*set shipaddressId if stationary group*/\
                if ($scope.user.Groups[0].Name == 'Stationery') \{\
                    $scope.currentOrder.ShipAddressID = $scope.shipaddresses[0].ID;\
            ...
            $scope.$on('event:AddressSaved', function(event, address) \{\
                ...
                AddressList.shipping(function(list) \{\
                    ...
                    if ($scope.isEditforApproval) \{\
                        $scope.shipaddresses.push($scope.currentOrder.ShipAddress);\
                        //$scope.shipaddresses.push($scope.currentOrder.BillAddress); //bug fix\
                    \}\
                \});\
                $scope.shipaddress = \{ Country: 'US', IsShipping: true, IsBilling: false \};\
            \});\
